...
from task import SMILESCNNModel, get_model_params, load_data, evaluate_model
...
def evaluate_global_model(server_round, parameters, config):
    ...
    from task import set_model_params
    ...
    if server_round == 10:  # Final round
        results_path = Path("results/federated_results.json")
